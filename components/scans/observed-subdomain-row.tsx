...
export type ObservedSubdomainRowData = {
...
export function ObservedSubdomainRow({
  row,
  targetDomainId,
  scanJobId,
}: {
  row: ObservedSubdomainRowData;
  ...
  return (
    <button
      type="button"
      onClick={() => openHostnamePanel(targetDomainId, row.hostnameNormalized, { scanJobId })}
